...
/**
 * @brief Écriture sur le terminal.
 *
 * Cette fonction est appelée pour écrire sur le périphérique rattaché au 
 * terminal (exemple: la console).
 *
 * @param ofd Le descripteur de fichier ouvert.
 * @param buf Le buffer qui contient les données à écrire.
...
/**
 * @brief Lecture sur le terminal.
 *
 * Lecture des données stockées dans le buffer du terminal.
 *
 * @param ofd Le descripteur de fichier ouvert.
 * @param buf Le buffer où placer les données.
