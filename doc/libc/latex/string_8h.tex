...
\subsubsection[{memcpy}]{\setlength{\rightskip}{0pt plus 5cm}\-\_\-\-\_\-\-B\-E\-G\-I\-N\-\_\-\-D\-E\-C\-L\-S void$\ast$ {\bf memcpy} (
\begin{DoxyParamCaption}
\item[{void $\ast$}]{dest, }
...
\subsubsection[{strchrnul}]{\setlength{\rightskip}{0pt plus 5cm}char$\ast$ {\bf strchrnul} (
\begin{DoxyParamCaption}
\item[{const char $\ast$}]{s, }
\item[{int}]{c}
\end{DoxyParamCaption}
...
\subsubsection[{strndup}]{\setlength{\rightskip}{0pt plus 5cm}char$\ast$ {\bf strndup} (
\begin{DoxyParamCaption}
\item[{const char $\ast$}]{s, }
\item[{{\bf size\-\_\-t}}]{n}
\end{DoxyParamCaption}
...
\subsubsection[{strtok}]{\setlength{\rightskip}{0pt plus 5cm}char$\ast$ {\bf strtok} (
\begin{DoxyParamCaption}
\item[{char $\ast$}]{str, }
