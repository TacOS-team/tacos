...
\subsubsection[{isalnum}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf isalnum} (
...
\subsubsection[{isalpha}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf isalpha} (
\begin{DoxyParamCaption}
\item[{int}]{c}
\end{DoxyParamCaption}
...
\subsubsection[{isblank}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf isblank} (
\begin{DoxyParamCaption}
\item[{int}]{c}
\end{DoxyParamCaption}
...
\subsubsection[{iscntrl}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf iscntrl} (
\begin{DoxyParamCaption}
\item[{int}]{c}
\end{DoxyParamCaption}
...
\subsubsection[{isdigit}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf isdigit} (
\begin{DoxyParamCaption}
\item[{int}]{c}
\end{DoxyParamCaption}
...
\subsubsection[{islower}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf islower} (
\begin{DoxyParamCaption}
\item[{int}]{c}
\end{DoxyParamCaption}
...
\subsubsection[{isprint}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf isprint} (
\begin{DoxyParamCaption}
\item[{int}]{c}
\end{DoxyParamCaption}
...
\subsubsection[{ispunct}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf ispunct} (
\begin{DoxyParamCaption}
\item[{int}]{c}
\end{DoxyParamCaption}
...
\subsubsection[{isspace}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf isspace} (
\begin{DoxyParamCaption}
\item[{int}]{c}
\end{DoxyParamCaption}
)}}\label{ctype_8c_a56be4166e4673843042a548a7f513dbc}
\-Vérifie si l'on a un caractère blanc, d'espacement. \-Il s'agit de \-: espace, saut de page (form-\/feed, '$\backslash$f'), saut de ligne (newline, '$\backslash$n'), retour chariot (carriage return, '$\backslash$r'), tabulation horizontale ('$\backslash$t'), et tabulation verticale ('$\backslash$v').
...
\subsubsection[{isupper}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf isupper} (
\begin{DoxyParamCaption}
\item[{int}]{c}
\end{DoxyParamCaption}
...
\subsubsection[{isxdigit}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf isxdigit} (
\begin{DoxyParamCaption}
\item[{int}]{c}
\end{DoxyParamCaption}
...
\subsubsection[{tolower}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf tolower} (
\begin{DoxyParamCaption}
\item[{int}]{c}
\end{DoxyParamCaption}
...
\begin{center}
\leavevmode
\includegraphics[width=238pt]{ctype_8c_ac79d6114c9df7350cedcd8cf921a6ea4_icgraph}
\end{center}
\end{figure}
...
\subsubsection[{toupper}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf toupper} (
\begin{DoxyParamCaption}
\item[{int}]{c}
\end{DoxyParamCaption}
