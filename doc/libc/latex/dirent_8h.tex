...
\begin{DoxyCompactItemize}
\item 
int \hyperlink{dirent_8h_aee98bbe743c2d14dbaa67f01c3fb9ed5}{mkdir} (const char $\ast$pathname, \hyperlink{stat_8h_af8f4385bb42836d1e3ad4fea9d71d1b9}{mode\-\_\-t} mode)
\item 
...
\subsubsection[{\-N\-A\-M\-E\-\_\-\-M\-A\-X}]{\setlength{\rightskip}{0pt plus 5cm}\#define {\bf \-N\-A\-M\-E\-\_\-\-M\-A\-X}~256}}\label{dirent_8h_ac64541bdd81c961304b9babef1402640}
...
\subsubsection[{closedir}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf closedir} (
...
\subsubsection[{mkdir}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf mkdir} (
\begin{DoxyParamCaption}
...
\subsubsection[{opendir}]{\setlength{\rightskip}{0pt plus 5cm}{\bf \-D\-I\-R}$\ast$ {\bf opendir} (
\begin{DoxyParamCaption}
...
\subsubsection[{readdir}]{\setlength{\rightskip}{0pt plus 5cm}struct {\bf dirent}$\ast$ {\bf readdir} (
\begin{DoxyParamCaption}
\item[{{\bf \-D\-I\-R} $\ast$}]{dirp}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}read\mbox{]}}}}\label{dirent_8h_a58257faf8b13b3f14558613c632b2373}
