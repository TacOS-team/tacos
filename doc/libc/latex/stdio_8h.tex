...
\subsubsection[{clearerr}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf clearerr} (
...
\subsubsection[{feof}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf feof} (
\begin{DoxyParamCaption}
\item[{{\bf \-F\-I\-L\-E} $\ast$}]{stream}
\end{DoxyParamCaption}
...
\subsubsection[{ferror}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf ferror} (
\begin{DoxyParamCaption}
\item[{{\bf \-F\-I\-L\-E} $\ast$}]{stream}
\end{DoxyParamCaption}
...
\subsubsection[{fgetc}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf fgetc} (
\begin{DoxyParamCaption}
\item[{{\bf \-F\-I\-L\-E} $\ast$}]{stream}
\end{DoxyParamCaption}
...
\subsubsection[{fgets}]{\setlength{\rightskip}{0pt plus 5cm}char$\ast$ {\bf fgets} (
\begin{DoxyParamCaption}
\item[{char $\ast$}]{s, }
\item[{int}]{size, }
\item[{{\bf \-F\-I\-L\-E} $\ast$}]{stream}
...
\subsubsection[{fileno}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf fileno} (
\begin{DoxyParamCaption}
\item[{{\bf \-F\-I\-L\-E} $\ast$}]{stream}
\end{DoxyParamCaption}
...
\subsubsection[{fmemopen}]{\setlength{\rightskip}{0pt plus 5cm}{\bf \-F\-I\-L\-E}$\ast$ {\bf fmemopen} (
\begin{DoxyParamCaption}
\item[{void $\ast$}]{buf, }
...
\begin{center}
\leavevmode
\includegraphics[width=204pt]{stdio_8h_ad9291335f34e874c8431285d705bc3aa_icgraph}
\end{center}
\end{figure}
...
\subsubsection[{fread}]{\setlength{\rightskip}{0pt plus 5cm}{\bf size\-\_\-t} {\bf fread} (
\begin{DoxyParamCaption}
\item[{void $\ast$}]{ptr, }
\item[{{\bf size\-\_\-t}}]{size, }
...
\subsubsection[{fwrite}]{\setlength{\rightskip}{0pt plus 5cm}{\bf size\-\_\-t} {\bf fwrite} (
\begin{DoxyParamCaption}
...
\subsubsection[{perror}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf perror} (
\begin{DoxyParamCaption}
...
\subsubsection[{remove}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf remove} (
\begin{DoxyParamCaption}
...
\subsubsection[{setvbuf}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf setvbuf} (
\begin{DoxyParamCaption}
\item[{{\bf \-F\-I\-L\-E} $\ast$}]{stream, }
\item[{char $\ast$}]{buf, }
\item[{int}]{mode, }
...
\subsubsection[{\-\_\-\-\_\-file\-\_\-list}]{\setlength{\rightskip}{0pt plus 5cm}{\bf \-F\-I\-L\-E}$\ast$ {\bf \-\_\-\-\_\-file\-\_\-list}}}\label{stdio_8h_ad9a717e4aa4b82cb2e26752399eaa918}
