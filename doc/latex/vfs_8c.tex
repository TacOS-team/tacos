...
\item 
\#define \hyperlink{vfs_8c_af49093660b32a1c31675eb2340d857ba}{L\+O\+O\+K\+U\+P\+\_\+\+N\+O\+F\+O\+L\+L\+O\+W}~2
\end{DoxyCompactItemize}
...
\hyperlink{fd__types_8h_a42bccb9b6a816213613cefffced245f0}{open\+\_\+file\+\_\+descriptor} $\ast$ \hyperlink{vfs_8c_a7b293d0cca90e9f633dc69cc5900c430}{vfs\+\_\+open} (const char $\ast$pathname, \hyperlink{kernel_2include_2types_8h_a33594304e786b158f3fb30289278f5af}{uint32\+\_\+t} flags)
\begin{DoxyCompactList}\small\item\em Ouverture d'un fichier. \end{DoxyCompactList}\item 
int \hyperlink{vfs_8c_ab0c805d30412c7b434adf437a404ce6a}{vfs\+\_\+close} (\hyperlink{fd__types_8h_a42bccb9b6a816213613cefffced245f0}{open\+\_\+file\+\_\+descriptor} $\ast$ofd)
...
int \hyperlink{vfs_8c_a3846bd89eec883701f1487abba137164}{vfs\+\_\+stat} (const char $\ast$pathname, struct \hyperlink{structstat}{stat} $\ast$buf, int follow\+\_\+link)
...
int \hyperlink{vfs_8c_a631bdc2a44ac1b7477782b058277a8d3}{vfs\+\_\+readdir} (\hyperlink{fd__types_8h_a42bccb9b6a816213613cefffced245f0}{open\+\_\+file\+\_\+descriptor} $\ast$ofd, char $\ast$entries, \hyperlink{kernel_2include_2types_8h_a29d85914ddff32967d85ada69854206d}{size\+\_\+t} size)
\begin{DoxyCompactList}\small\item\em Lecture de plusieurs entrées d'un dossier. \end{DoxyCompactList}\item 
\hypertarget{vfs_8c_ab90439d8a7a9b3dfacad832a957493b0}{\hyperlink{kernel_2include_2types_8h_af629ed855824cf5955b54529adf78ad6}{ssize\+\_\+t} {\bfseries vfs\+\_\+readlink} (const char $\ast$path, char $\ast$buf, \hyperlink{kernel_2include_2types_8h_a29d85914ddff32967d85ada69854206d}{size\+\_\+t} bufsize)}\label{vfs_8c_ab90439d8a7a9b3dfacad832a957493b0}

\end{DoxyCompactItemize}
\subsection*{Variables}
\begin{DoxyCompactItemize}
\item 
\hypertarget{vfs_8c_a03e43e12af080f1b15566b6ca357a9ca}{struct \hyperlink{struct__open__file__operations__t}{\+\_\+open\+\_\+file\+\_\+operations\+\_\+t} {\bfseries pipe\+\_\+fops}}\label{vfs_8c_a03e43e12af080f1b15566b6ca357a9ca}
...
\hypertarget{vfs_8c_af49093660b32a1c31675eb2340d857ba}{\index{vfs.\+c@{vfs.\+c}!L\+O\+O\+K\+U\+P\+\_\+\+N\+O\+F\+O\+L\+L\+O\+W@{L\+O\+O\+K\+U\+P\+\_\+\+N\+O\+F\+O\+L\+L\+O\+W}}
\index{L\+O\+O\+K\+U\+P\+\_\+\+N\+O\+F\+O\+L\+L\+O\+W@{L\+O\+O\+K\+U\+P\+\_\+\+N\+O\+F\+O\+L\+L\+O\+W}!vfs.\+c@{vfs.\+c}}
\subsubsection[{L\+O\+O\+K\+U\+P\+\_\+\+N\+O\+F\+O\+L\+L\+O\+W}]{\setlength{\rightskip}{0pt plus 5cm}\#define L\+O\+O\+K\+U\+P\+\_\+\+N\+O\+F\+O\+L\+L\+O\+W~2}}\label{vfs_8c_af49093660b32a1c31675eb2340d857ba}
Ne résoud pas le dernier lien. \hypertarget{vfs_8c_a63ed32a1a370c741228dad9092324038}{\index{vfs.\+c@{vfs.\+c}!L\+O\+O\+K\+U\+P\+\_\+\+P\+A\+R\+E\+N\+T@{L\+O\+O\+K\+U\+P\+\_\+\+P\+A\+R\+E\+N\+T}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{vfs_8c_ab0c805d30412c7b434adf437a404ce6a_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{vfs_8c_ab0c805d30412c7b434adf437a404ce6a_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=290pt]{vfs_8c_a392f80d5c4ab48178abcd268c3f64c45_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=296pt]{vfs_8c_a54142c2a2009cc49e3b3b8c12d955b04_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{vfs_8c_a7b293d0cca90e9f633dc69cc5900c430_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=224pt]{vfs_8c_a631bdc2a44ac1b7477782b058277a8d3_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{vfs_8c_a8f5dc4e5e4a2aa5d7649790256f11685_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=288pt]{vfs_8c_a8f5dc4e5e4a2aa5d7649790256f11685_icgraph}
\end{center}
\end{figure}


\hypertarget{vfs_8c_a3846bd89eec883701f1487abba137164}{\index{vfs.\+c@{vfs.\+c}!vfs\+\_\+stat@{vfs\+\_\+stat}}
...
\end{DoxyParamCaption}
)}}\label{vfs_8c_a3846bd89eec883701f1487abba137164}
...
\begin{center}
\leavevmode
\includegraphics[width=288pt]{vfs_8c_a3846bd89eec883701f1487abba137164_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=231pt]{vfs_8c_a69a4424755e56bad13f341c1600db527_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{vfs_8c_a4f8b6a1f2b0e6012446196f18b33d686_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=292pt]{vfs_8c_a4f8b6a1f2b0e6012446196f18b33d686_icgraph}
\end{center}
\end{figure}
