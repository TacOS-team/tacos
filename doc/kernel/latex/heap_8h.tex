...
\begin{center}
\leavevmode
\includegraphics[width=268pt]{heap_8h__dep__incl}
\end{center}
\end{figure}
...
\begin{DoxyCompactItemize}
\item 
void \hyperlink{heap_8h_ad1e10f55e192cb2229ba2b294eee1306}{init\-Heap} (\hyperlink{structheap__t}{heap\-\_\-t} $\ast$h, \hyperlink{list_8h_a35d066d4adbc5a7903210dcce0bf4717}{cmp\-\_\-func\-\_\-type} cmp, void $\ast$heap, \hyperlink{types_8h_a29d85914ddff32967d85ada69854206d}{size\-\_\-t} elements\-\_\-size, int max\-\_\-elements)
\item 
...
\subsubsection[{\-H\-E\-A\-P\-\_\-\-M\-A\-X\-\_\-\-S\-I\-Z\-E}]{\setlength{\rightskip}{0pt plus 5cm}\#define {\bf \-H\-E\-A\-P\-\_\-\-M\-A\-X\-\_\-\-S\-I\-Z\-E}~256}}\label{heap_8h_a7085c62c43230e23f6fa23eed518061e}
...
\subsubsection[{cmp\-\_\-func\-\_\-type}]{\setlength{\rightskip}{0pt plus 5cm}typedef int($\ast$ {\bf cmp\-\_\-func\-\_\-type})(void $\ast$, void $\ast$)}}\label{heap_8h_a35d066d4adbc5a7903210dcce0bf4717}
...
\subsubsection[{add\-Element}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf add\-Element} (
...
\begin{center}
\leavevmode
\includegraphics[width=238pt]{heap_8h_af42ea714951cb83a022c742d5bce5300_cgraph}
\end{center}
\end{figure}
...
\subsubsection[{get\-Top}]{\setlength{\rightskip}{0pt plus 5cm}void$\ast$ {\bf get\-Top} (
\begin{DoxyParamCaption}
\item[{{\bf heap\-\_\-t} $\ast$}]{h}
\end{DoxyParamCaption}
...
\end{DoxyParams}
\begin{DoxyReturn}{\-Renvoie}
pointeur vers le premier élément du tas, \-N\-U\-L\-L si aucun. 
\end{DoxyReturn}
...
\subsubsection[{init\-Heap}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf init\-Heap} (
\begin{DoxyParamCaption}
\item[{{\bf heap\-\_\-t} $\ast$}]{h, }
...
\subsubsection[{removetop}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf removetop} (
\begin{DoxyParamCaption}
\item[{{\bf heap\-\_\-t} $\ast$}]{h}
\end{DoxyParamCaption}
...
\begin{center}
\leavevmode
\includegraphics[width=232pt]{heap_8h_ab2d2b864167da4bf231eb63de7c83ff1_cgraph}
\end{center}
\end{figure}
