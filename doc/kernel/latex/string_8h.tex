\hypertarget{string_8h}{\section{\-Référence du fichier kernel/include/klibc/string.h}
\label{string_8h}\index{kernel/include/klibc/string.\-h@{kernel/include/klibc/string.\-h}}
}
...
\begin{center}
\leavevmode
\includegraphics[width=214pt]{string_8h__incl}
\end{center}
\end{figure}
...
\item 
void $\ast$ \hyperlink{string_8h_ad1b7311b48288a0d08172f26ff64dd67}{memcpy} (void $\ast$dest, const void $\ast$src, \hyperlink{types_8h_a29d85914ddff32967d85ada69854206d}{size\-\_\-t} size)
...
\begin{DoxyCompactList}\small\item\em \-Compare deux chaînes jusqu'à n caractères. \end{DoxyCompactList}\item 
\hypertarget{string_8h_a48d911e1a150610b7182d19b81651828}{char $\ast$ {\bfseries strchrnul} (const char $\ast$s, int c)}\label{string_8h_a48d911e1a150610b7182d19b81651828}
...
\hypertarget{string_8h_a8cb460f64c449f2a9b9b7a40569ce0fe}{char $\ast$ {\bfseries strtok} (char $\ast$str, const char $\ast$delim)}\label{string_8h_a8cb460f64c449f2a9b9b7a40569ce0fe}
...
\subsubsection[{memcmp}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf memcmp} (
...
\end{DoxyReturn}
\hypertarget{string_8h_ad1b7311b48288a0d08172f26ff64dd67}{\index{string.\-h@{string.\-h}!memcpy@{memcpy}}
...
\end{DoxyParamCaption}
)}}\label{string_8h_ad1b7311b48288a0d08172f26ff64dd67}
\-La fonction \hyperlink{string_8h_ad1b7311b48288a0d08172f26ff64dd67}{memcpy()} copie une zone mémoire de size octets depuis src vers la zone mémoire dest. \-Les deux zones ne doivent pas se chevaucher sinon il faut utiliser memmove.
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{string_8h_ad1b7311b48288a0d08172f26ff64dd67_icgraph}
\end{center}
\end{figure}
...
\subsubsection[{strcasecmp}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf strcasecmp} (
\begin{DoxyParamCaption}
...
\subsubsection[{strcasestr}]{\setlength{\rightskip}{0pt plus 5cm}char$\ast$ {\bf strcasestr} (
\begin{DoxyParamCaption}
\item[{const char $\ast$}]{haystack, }
\item[{const char $\ast$}]{needle}
\end{DoxyParamCaption}
)}}\label{string_8h_ae9229017a4501f8d6a637b4498cfed2e}
\-Recherche needle (aiguille) dans la chaine heystack (meule de foin). \-Les caractères « $\backslash$0 » ne sont pas comparés. \-La casse des arguments est ignorée.
...
\-Ajoute à la fin de s1 le contenu de s2 en s'arrêtant au premier caractère '$\backslash$0' rencontré.
...
\-Copie la chaine s2 vers la zone mémoire pointée par s1. \-La copie s'arrête dès que le caractère '$\backslash$0' est rencontré dans s2.
...
\subsubsection[{strdup}]{\setlength{\rightskip}{0pt plus 5cm}char$\ast$ {\bf strdup} (
\begin{DoxyParamCaption}
\item[{const char $\ast$}]{s}
\end{DoxyParamCaption}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{string_8h_ab1cc1a3ff560049e22576031c7c2345b_cgraph}
\end{center}
\end{figure}
...
\subsubsection[{strlen}]{\setlength{\rightskip}{0pt plus 5cm}{\bf size\-\_\-t} {\bf strlen} (
\begin{DoxyParamCaption}
\item[{const char $\ast$}]{s}
\end{DoxyParamCaption}
)}}\label{string_8h_aa383452fe445bfae989358c9d7d96f4f}
\-La fonction \hyperlink{string_8h_aa383452fe445bfae989358c9d7d96f4f}{strlen()} calcule la longueur de la chaîne de caractères s sans compter le caractère nul « $\backslash$0 »
...
\subsubsection[{strncasecmp}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf strncasecmp} (
\begin{DoxyParamCaption}
\item[{const char $\ast$}]{s1, }
\item[{const char $\ast$}]{s2, }
\item[{{\bf size\-\_\-t}}]{n}
...
\-Ajoute à la fin de s1 le contenu de s2 en s'arrêtant à n caractères ou au premier caractère '$\backslash$0' rencontré.
...
\-Copie la chaine s2 vers la zone mémoire pointée par s1 en s'arrêtant aux n premiers caractères de s1. \-La copie s'arrête au bout de n caractères ou dès que le caractère '$\backslash$0' est lu dans la chaine source s2. \-Attention, la chaîne s1 ne contient pas forcément le caractère '$\backslash$0' si la limite des n caractères est atteinte.
...
\begin{center}
\leavevmode
\includegraphics[width=234pt]{string_8h_a7982e2515766b25c1157ac30f8bac394_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{string_8h_a0c05a458deff028ef4d4e64059098db4_icgraph}
\end{center}
\end{figure}
...
\subsubsection[{strstr}]{\setlength{\rightskip}{0pt plus 5cm}char$\ast$ {\bf strstr} (
\begin{DoxyParamCaption}
\item[{const char $\ast$}]{haystack, }
\item[{const char $\ast$}]{needle}
\end{DoxyParamCaption}
)}}\label{string_8h_a4a710d86541afc6b7dafddcdb4b1c94f}
\-Recherche needle (aiguille) dans la chaine heystack (meule de foin). \-Les caractères « $\backslash$0 » ne sont pas comparés.
